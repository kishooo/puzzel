...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" src="<?php echo e(asset('/assets/images/ufida.jpg')); ?>" alt="First slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="<?php echo e(asset('/assets/images/ufi.jpg')); ?>" alt="Second slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="<?php echo e(asset('/assets/images/ufida.jpg')); ?>" alt="Third slide">
      </div>
    </div>
  ...
  <div class="container">
                ...
                <div class="small-container">
                    <div class="row col-12">
                      <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-3">
                            <a href="/HomePage/category/<?php echo e($category->categoryId); ?>"><?php echo e($category->title); ?> <img class="responsive" src="images/shopping-bag.png"></a>
                        </div>
            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-4">
                        <a href="description.html"><img src="#"></a>
...
<?php echo $__env->make('userInterface.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\htdocs\laravel\ufida\resources\views/userInterface/Home.blade.php ENDPATH**/ ?>